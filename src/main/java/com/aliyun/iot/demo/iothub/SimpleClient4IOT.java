...
public class SimpleClient4IOT {
    ...
    private static String dataTopic = "/" + productKey + "/" + deviceName + "/data";
    ...
    public static void connectMqtt(String url, String clientId, String mqttUsername,
        ...
        //sampleClient.subscribe(pubTopic); //设备没有对应的Topic权限
        //一次订阅永久生效
        //这个是第一种订阅topic方式，回调到统一的callback
//        sampleClient.subscribe("/shadow/get/a1k9JgOkfBQ/"+deviceName);
//        sampleClient.subscribe(dataTopic);
//        sampleClient.subscribe("/"+productKey+"/"+deviceName+"/log");
//        sampleClient.subscribe("/" + "a1k9JgOkfBQ" + "/" + "device_EuSL" + "/get");
        //只能订阅自己在控制台中拥有的topic
